...
- Optional: save final bills to Google Drive — Settings → Google Drive → **Connect** (no setup needed; details in [docs/google-drive-setup.md](docs/google-drive-setup.md)).
